...
{
    auto* time = std::localtime(&latched_time);
...
void gameboy::memory::controller::RTC::write(const uint8_t data)
{
...
void gameboy::memory::controller::MBC3::control(const gameboy::memory::Address16& virtual_address, const uint8_t data)
{
...
void gameboy::memory::controller::MBC3::select_rom_bank(const uint8_t data)
{
    rom_bank = data & 0x7Fu;
}

void gameboy::memory::controller::MBC3::select_ram_bank(const uint8_t data)
{
    ram_bank = data & 0x03u;
}
...
void gameboy::memory::controller::MBC3::configure_latch(const uint8_t data)
{
