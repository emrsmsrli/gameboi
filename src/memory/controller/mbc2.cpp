...
void gameboy::mbc2::control(const gameboy::address16& address, const uint8_t data) noexcept
{
...
uint8_t gameboy::mbc2::read_ram(const std::vector<uint8_t>& ram, const physical_address& address) const noexcept
{
    return ram[address.value()];
}

void gameboy::mbc2::write_ram(
